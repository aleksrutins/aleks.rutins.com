<div class="flex flex-col gap-3 z-10 bg-stone-100/75 backdrop-blur border-r p-5 h-screen absolute transition-all" :class="{'shadow-lg rounded-lg border m-2 h-[calc(100vh-1rem)]': sidebarOpen}" x-on:mouseenter="sidebarOpen = true" x-on:mouseleave="sidebarOpen = false" x-data>
